...
/*let dia = weekDays.slice(1,2)
weekDays.splice(1,1)
weekDays.splice(2,0,dia)
console.log("new week is "+ weekDays)
...
/*let changeOrder= weekDays.shift();
weekDays.push(changeOrder);
...
const reverseWrittenNumbers= writtenNumbers.reverse();
console.log(reverseWrittenNumbers)
/*------------------
9)
...
const numTimesSeven = [];
numTimesSeven.push((num.shift()*7),(num.shift()*7),(num.shift()*7));
