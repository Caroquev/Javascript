...
person["adress"]= "Barcelona";
person["phonenumber"]= "654924462";
person["studies"]= "Batxillerat";
console.log(person);
...
const animal={
  ...
  color: "brown",
  food:{
    normalFood:"bread crumbs",
    extremeConditionsFood: "other animals",
       } 
       }
...
------------------*/
user2.personalInfo.address.city;
