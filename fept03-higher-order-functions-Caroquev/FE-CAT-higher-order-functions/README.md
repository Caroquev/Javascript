# Funcions d'Ordre Superior (Higher Order Functions)

En aquest repositori practicaràs la sintaxi i l'ús de les _High Order Functions_ (HOF).

## Objectius

- Declarar i cridar _high order functions_ (HOF).
